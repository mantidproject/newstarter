 ...
 */
Rectangle* ShapeFactory::createRectangle(const double &height, const double &width){
 ...
 */
Triangle* ShapeFactory::createTriangle(const double &height, const double &base){
