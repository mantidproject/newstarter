...
int Triangle::getNumSides() const { return 3; }
...
ShapeType Triangle::getType() const { return ShapeType::triangle; }

std::string Triangle::toString() const {
  return std::string("triangle(base=") + std::to_string(m_base) + ", height=" +
